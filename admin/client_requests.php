		...
		<div id="main">
			...
			<div id="content">
				...
				<div class="box">
					<!-- Box Head -->
					<div class="box-head">
						<h2 class="left">Permintaan Clent</h2>
						<div class="right">
							<label>Cari</label>
					...
					<div class="table">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								...
								<td><a href="javascript:sureToApprove(<?php echo $row['client_id'];?>)" class="ico del">Disetujui</a><a href="javascript:sureToDelete(<?php echo $row['msg_id'];?>)" class="ico edit">Hapus</a></td>
							</tr>
							<?php
								}
							?>
